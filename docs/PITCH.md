...
| 0:12–0:30 | **Speak** tab: Pidgin voice note plays → fields fill → ⛔ credit check on Oga Emeka → Confirm | "With TradeVoice, the trader just talks. Whisper, running on our own NVIDIA Brev GPU, hears the Pidgin; NVIDIA Nemotron turns it into a record. And before giving more credit, it warns: Oga Emeka is already 18 days late." |
...
| 0:42–0:55 | **Who owes me** → 🔴 late → Pidgin reminder → WhatsApp opens | "Who owes me, who's late, and a polite reminder in Pidgin, English or Yoruba, one tap to WhatsApp." |
...
| 1:20–1:30 | Privacy tab → team photo | "Audio and photos are deleted, nothing is saved without the trader's OK, and the score is advice, not a loan decision. Next: a WhatsApp bot and Hausa and Igbo. We're TradeVoice." |
...
- **Tools:** NVIDIA Brev (Whisper large-v3-turbo on GPU) · NVIDIA API (Nemotron text + vision, with fallbacks) · Gradio · SQLite · Python
- **Demo:** ______ (public link) · **Video:** ______ · **Code:** https://github.com/Godzilla-lab/tradevoice
- **Next step:** WhatsApp voice-note bot; Hausa/Igbo/Yoruba speech; pilot with 10 traders in Yaba & Balogun markets;
